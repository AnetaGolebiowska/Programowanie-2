...
public class BookLoaderTest {
    ...
    @Test
    public void testBookLoaderCategorie(){
        Assert.assertEquals(testCategorie,
                BookLoader.fileLoadCategories("src/test/java/library/categoriesTest.csv"));
    }
    @Test
    public void testBookLoaderAuthorsList(){
        Assert.assertEquals(testAuthorList,
                BookLoader.fileLoadAuthors("src/test/java/library/authorsTest.csv"));
    }

    @Test
    public void testLoaderBook(){
